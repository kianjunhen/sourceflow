      ...
      <div className="hidden md:flex gap-[30px] items-center">
        {items.map((item) => (
          <div className="relative group" key={item.name}>
            <button className="text-[#1A1A1A] hover:text-black text-base flex items-center">
              {item.name}
              <img
                src={chevron}
                alt="Chevron"
            ...
            {item.subItems && (
              <div className="absolute left-0 mt-2 w-40 bg-white shadow-lg rounded-md opacity-0 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-200 translate-y-2 z-10">
